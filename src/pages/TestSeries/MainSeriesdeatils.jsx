...
// //         const response = await axios.get(`https://alic-website-2.onrender.com/main/maintestseries/${id}`);
// //         if (!response.data) {
...
// //             `https://alic-website-2.onrender.com/main/maintestseries?category=${categoryId}&limit=4&exclude=${id}`
// //           );
